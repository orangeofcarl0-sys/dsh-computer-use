...
/** 观察结果缓存为快照（element_token 自带引擎侧校验，双保险之一）。 */
function cacheSnapshot(cfg, target, state, elements, effectiveMode) {
...
export async function screenObserve(ctx, args, cfg, exec) {
  ...
  cacheSnapshot(cfg, target, state, elements, effectiveMode)
